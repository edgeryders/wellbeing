...
export default {
  ...
  methods: {
    ...
    getPosts() {
          ...
          axios.get("https://api.particip.io/get-data?endpoint=https://edgeryders.eu/c/wellbeing/eu")
              .then(({ data }) => {
      ...
      getFeatured() {
          ...
          axios.get("https://api.particip.io/get-data?endpoint=https://edgeryders.eu/tags/webcontent-wellbeing-featured-german")
              .then(({ data }) => {
