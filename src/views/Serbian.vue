...
import tamaraProfile from '../assets/tamara_vukcevic.jpeg'
...
export default {
  ...
  data() {
    return {
      ...
      bios: [
        {
          name: "Jasen Lakic",
          username: "jasen_lakic",
          avatar:
            "https://edgeryders.eu/uploads/default/original/2X/9/9ff60830d62d7ae0c2ff4c7e9d99649268f222c8.jpeg",
          byline: "Preduzetnik",
        ...
        },
        {
          name: "Maria Euler",
          username: "MariaEuler",
          avatar: "https://edgeryders.eu/user_avatar/edgeryders.eu/mariaeuler/240/9955_2.png",
  ...
  methods: {
    ...
    getPosts() {
          ...
          axios.get("https://api.particip.io/get-data?endpoint=https://edgeryders.eu/c/wellbeing/rs")
              .then(({ data }) => {
      ...
      getFeatured() {
          ...
          axios.get("https://api.particip.io/get-data?endpoint=https://edgeryders.eu/tags/webcontent-wellbeing-featured-serbian")
              .then(({ data }) => {
