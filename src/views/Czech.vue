...
export default {
  ...
  methods: {
    ...
    getPosts() {
          ...
          axios.get("https://api.particip.io/get-data?endpoint=https://edgeryders.eu/c/wellbeing/cz")
              .then(({ data }) => {
      ...
      getFeatured() {
          ...
          axios.get("https://api.particip.io/get-data?endpoint=https://edgeryders.eu/tags/webcontent-wellbeing-featured-czech")
              .then(({ data }) => {
